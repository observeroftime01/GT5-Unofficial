...
public class GT_Loader_Item_Block_And_Fluid implements Runnable {
    ...
    public void run() {
        ...
        GT_Mod.gregtechproxy.addFluid("Uraniumhexafluoride", "molten.autogenerated", "Uranium Hexafluoride", GTNH_ExtraMaterials.UraniumHexafluoride, GTNH_ExtraMaterials.UraniumHexafluoride.mRGBa, 2, 170, GT_OreDictUnificator.get(OrePrefixes.cell, GTNH_ExtraMaterials.UraniumHexafluoride, 1L), ItemList.Cell_Empty.get(1L, new Object[0]), 1000);
