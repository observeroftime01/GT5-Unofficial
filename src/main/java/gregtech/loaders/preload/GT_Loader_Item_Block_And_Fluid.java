...
public class GT_Loader_Item_Block_And_Fluid implements Runnable {
    ...
    public void run() {
        ...
        GT_Mod.gregtechproxy.addFluid("radioactivesludge", "molten.autogenerated", "Radioactive Sludge", GTNH_ExtraMaterials.RadioactiveSludge, GTNH_ExtraMaterials.RadioactiveSludge.mRGBa, 1, 298, GT_OreDictUnificator.get(OrePrefixes.cell, GTNH_ExtraMaterials.RadioactiveSludge, 1L), ItemList.Cell_Empty.get(1L, new Object[0]), 1000);
        GT_Mod.gregtechproxy.addFluid("ImpUranylNitrateConc", "molten.autogenerated", "Impure Uranyl Nitrate Concentrate", GTNH_ExtraMaterials.ImpUranylNitrateConc, GTNH_ExtraMaterials.ImpUranylNitrateConc.mRGBa, 1, 298, GT_OreDictUnificator.get(OrePrefixes.cell, GTNH_ExtraMaterials.ImpUranylNitrateConc, 1L), ItemList.Cell_Empty.get(1L, new Object[0]), 1000);
        GT_Mod.gregtechproxy.addFluid("AquUranylNitrateConc", "molten.autogenerated", "Aqueous Uranyl Nitrate Solution", GTNH_ExtraMaterials.AquUranylNitrateConc, GTNH_ExtraMaterials.AquUranylNitrateConc.mRGBa, 1, 298, GT_OreDictUnificator.get(OrePrefixes.cell, GTNH_ExtraMaterials.AquUranylNitrateConc, 1L), ItemList.Cell_Empty.get(1L, new Object[0]), 1000);
        GT_Mod.gregtechproxy.addFluid("Ammoniumdiuranate", "molten.autogenerated", "Ammonium Diuranate", GTNH_ExtraMaterials.AmmoniumDiuranate, GTNH_ExtraMaterials.AmmoniumDiuranate.mRGBa, 1, 298, GT_OreDictUnificator.get(OrePrefixes.cell, GTNH_ExtraMaterials.AmmoniumDiuranate, 1L), ItemList.Cell_Empty.get(1L, new Object[0]), 1000);
        GT_Mod.gregtechproxy.addFluid("UraniumhexafluorideGT5u", "molten.autogenerated", "Uranium Hexafluoride", GTNH_ExtraMaterials.UraniumHexafluorideGT5u, GTNH_ExtraMaterials.UraniumHexafluorideGT5u.mRGBa, 2, 170, GT_OreDictUnificator.get(OrePrefixes.cell, GTNH_ExtraMaterials.UraniumHexafluorideGT5u, 1L), ItemList.Cell_Empty.get(1L, new Object[0]), 1000);
