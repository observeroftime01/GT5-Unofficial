...
public class GT_MachineRecipeLoader implements Runnable {
	...
	GT_Values.RA.addAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Steel, 4L), GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.TungstenSteel, 1L), ItemList.Robot_Arm_IV.get(2L), GT_Utility.getIntegratedCircuit(3)}, GT_Values.NF, ItemList.Casing_Gearbox_TungstenSteel.get(1L), 200, 30);
        ...
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Oil.getFluid(100L), new FluidStack[]{Materials.SulfuricHeavyFuel.getFluid(30),  Materials.SulfuricLightFuel.getFluid(100), Materials.SulfuricNaphtha.getFluid(40), Materials.SulfuricGas.getGas(120)}, null, 20, 96);
        ...
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Oil.getFluid(100L), new FluidStack[]{Materials.SulfuricGas.getGas(120), Materials.SulfuricNaphtha.getFluid(40), Materials.SulfuricLightFuel.getFluid(100), Materials.SulfuricHeavyFuel.getFluid(30)}, null, 32, 64);
        ...
        // Moved to CustomRecipeLoarder GT_Values.RA.addFusionReactorRecipe(Materials.Beryllium.getMolten(16), Materials.Deuterium.getGas(375), Materials.Nitrogen.getPlasma(125), 16, 16384, 180000000); //FT1+ Expensive //
    ...
    public void run2() {
        ...
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Infinity, 6L), GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Infinity, 1L), ItemList.Casing_MiningInfinity.get(1L), 50, 16);
