...
public class GT_CustomRecipeLoader implements Runnable {
        ...
        public void run() {
                ...
                }, ItemList.OreDrill5.get(1), 18000, Voltage.UV.getVoltage());
        ...
        public void addCircuitRecipes() {
                ...
                // Elite Circuit board
                GT_Values.RA.addChemicalRecipe(ItemList.Circuit_Board_Fiberglass.get(2L), GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Platinum, 1), Materials.SulfuricAcid.getFluid(500), null, ItemList.Circuit_Board_Multifiberglass.get(1L), GT_Values.NI, 600, 480, true);
