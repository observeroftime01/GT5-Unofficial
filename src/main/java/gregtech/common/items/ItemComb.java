...
public class ItemComb extends Item {
	...
	/**
	 * Turns combs directly into molten metals.
	 * @param volt should be the desired voltage for the process
	 * @param comb is the type of comb to be processed
	 * @param aMaterial is the material that should be generated by this process
     * @param fluidAmount is the amount of fluid generated, as a long
     * @param duration is the duration of the process, as an int
	 *
	 * **/
	public void addFluidExtractorProcess(CombType comb, Materials aMaterial, long fluidAmount, int duration, Voltage volt){
		RA.addFluidExtractionRecipe(GT_Utility.copyAmount(1, getStackForType(comb)), ItemList.FR_Wax.get(1L), aMaterial.getMolten(fluidAmount), 1000, duration, volt.getSimpleEnergy());
	}
