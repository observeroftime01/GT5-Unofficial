...
public class GTNH_ExtraMaterials implements IMaterialHandler {
    ...
    public static Materials ExtremeTurbineSteel     = new Materials( 958, TextureSet.SET_SHINY              ,  1024.0F, 20485760,13,    1|2       |64|128   , 189, 172, 213,   0,   "ExtremeTurbineSteel"    ,   "Extreme Turbine Steel"        ,    0,       0,      9000,  9000,true, false,  20,   1,   1, Dyes.dyeWhite       , Arrays.asList(new TC_Aspects.TC_AspectStack(TC_Aspects.METALLUM, 4), new TC_Aspects.TC_AspectStack(TC_Aspects.VITREUS, 3), new TC_Aspects.TC_AspectStack(TC_Aspects.ALIENIS, 2)));
    ...
    public static Materials UraniumTetrafluorideGT5u = new Materials(  118, TextureSet.SET_SHINY              ,   1.0F,      0,  1,  1|16                      , 69, 196, 164,    0,   "UraniumTetrafluorideGT5u","Uranium Tetrafluoride"              ,0,      0,         298,    0, false, false,   3,   1,   1, Dyes.dyeCyan, Arrays.asList(new TC_Aspects.TC_AspectStack(TC_Aspects.RADIO, 16), new TC_Aspects.TC_AspectStack(TC_Aspects.VENENUM, 16)));
    public static Materials UraniumHexafluorideGT5u = new Materials(  119, TextureSet.SET_SHINY              ,   1.0F,      0,  1,  16                       , 129, 230, 204,    0,   "UraniumHexafluorideGT5u" ,"Uranium Hexafluoride"              ,0,      0,         170,    0, false, false,   3,   1,   1, Dyes.dyeCyan, Arrays.asList(new TC_Aspects.TC_AspectStack(TC_Aspects.RADIO, 16), new TC_Aspects.TC_AspectStack(TC_Aspects.VENENUM, 16)));
    ...
    public static Materials GT5uTestMaterial        = new MaterialBuilder(130, TextureSet.SET_METALLIC, "GT5uTestMaterial").addDustItems().addMetalItems().setMaterialList(new MaterialStack(Materials.Aluminium, 2), new MaterialStack(Materials.Magnesite, 1), new MaterialStack(Materials.Fluorine, 2), new MaterialStack(Materials.Silicon,4)).addElectrolyzerRecipe().addFluid().setBlastFurnaceRequired(true).setBlastFurnaceTemp(8900).setDurability(5120000).setToolQuality(12).addGearItems().addToolHeadItems().setToolSpeed(716).setName("GT5uTestMaterial").setRGBA(255, 140, 247,0).setColor(Dyes.dyePink).setAspects(Arrays.asList(new TC_Aspects.TC_AspectStack(TC_Aspects.METALLUM, 4), new TC_Aspects.TC_AspectStack(TC_Aspects.POTENTIA, 3), new TC_Aspects.TC_AspectStack(TC_Aspects.EXANIMIS, 2))).addPlasma().constructMaterial();


    /* Some Free ID's
        130 - 240 = 110 free spaces
        409 - 459 = 50 free spaces
        461 - 469 = 8 free spaces
        474 - 484 = 10 free spaces
        546 - 589 = 43 free spaces
        743 - 769 = 26 free spaces
        771 - 799 = 28 free spaces
    */
