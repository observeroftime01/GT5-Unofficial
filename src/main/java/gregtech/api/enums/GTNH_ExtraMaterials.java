...
public class GTNH_ExtraMaterials implements IMaterialHandler {
    ...
    public static Materials Insanium                = new Materials( 104, TextureSet.SET_SHINY              ,  2048.0F, 40971520,14,  1|2    |32|64|128       , 252, 3, 211,   0,   "Insanium"             ,   "Insanium Turbine Alloy"        ,    0,       0,         9800,  9800,true, false,  20,   1,   1, Dyes.dyePink       , Arrays.asList(new TC_Aspects.TC_AspectStack(TC_Aspects.METALLUM, 12), new TC_Aspects.TC_AspectStack(TC_Aspects.VITREUS, 8), new TC_Aspects.TC_AspectStack(TC_Aspects.ALIENIS, 8)));
